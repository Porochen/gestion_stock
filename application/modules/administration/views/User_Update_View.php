               ...
               <div class="col-lg-12">
                  <div class="card card-block card-stretch card-height">
                     ...
                     <div class="card-body rec-pat">
                        <form action="<?=  base_url('administration/Utilisateurs/update') ?>" method="post" autocomplete="off">
                          <input type="hidden" value="<?=$user['id_admin_user']?>" class="form-control" name="id" id="id">
                        <div class="row">
                          <div class="col-md-6">
                            <label>Nom d'utilisateur</label> 
                           <input type="text" value="<?=$user['username']?>" class="form-control" name="username" id="username" placeholder="Nom d'utilisateur">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" value="<?=$user['telephone']?>" class="form-control" name="phone" id="phone" placeholder="Téléphone">
                            <font class="text-danger">
                             <?=form_error('phone')?>
                             </font>
                          </div>  
                    ...
                    <?php  } } ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <label>Adresse</label> 
                            <input type="text" value="<?=$user['adresse']?>" class="form-control" name="adresse" id="adresse" placeholder="Adresse">
                            <font class="text-danger">
                             <?=form_error('adresse')?>
                             </font>
                          </div><br>
                          ...
                          <div class="col-md-6 mt-4">
                            <input type="submit" class="btn btn-outline-primary form-control" value="Modifier">
                          </div>  
                        </div>
