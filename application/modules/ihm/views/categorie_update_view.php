    ...
    <div class="container-fluid">
      ...
      <div class="card card-block card-stretch card-height">
        ...
        <div class="card-body tdy-appoin">
         ...
         <form action="<?= base_url('index.php/ihm/categorie/update')?>" method="post">
          <div class="row">
            <input type="hidden" name="id_categorie"  value="<?=$categ['id_categorie']?>" class="form-control">
            <div class="col-md-6">
              <label>Description</label> 
              <input name="descr_categorie"  value="<?=$categ['descr_categorie']?>" class="form-control" placeholder="la description">
