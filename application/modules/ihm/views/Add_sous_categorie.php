    ...
    <div class="container-fluid">
      ...
      <div class="card card-block card-stretch card-height">
        ...
        <div class="card-body tdy-appoin">
         <form action="<?= base_url('index.php/ihm/Sous_categorie/add_new')?>" method="post">
          <div class="row">
            <div class="col-md-6">
              <label>Categories</label> 
              <select name="id_categorie" id="id_categorie" class="form-control">
               <option value="">Séléctionner</option>
<?php  foreach ($souscat as $value) { 
...
<?php  } } ?>
            ...
            <div class="col-md-6">
              ...
              <input name=" descr_sous_categorie" value="<?=set_value('descr_sous_categorie')?>" class="form-control" placeholder="la description">
