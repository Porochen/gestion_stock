      ...
      <div class="card card-block card-stretch card-height">
       <div class="card-header d-flex justify-content-between">
        <div class="header-title">
         <h4 class="card-title">Liste des produits vendues</h4>
       </div>
     </div>
...
var chart = Highcharts.chart('container', {
    ...
    title: {
      text: '<b> Produit vendue <br> Total=<?=$total ?></b>'
    },
       ...
       point:{
        events: {
          click: function()
          {
            ...
            $("#titre").html("Liste des produits vendus: "+this.desc);
            $("#myModal").modal();
            ...
            $("#mytable").DataTable({
              ...
              "ajax":
              {
                 url:"<?=base_url('rapport/Rapport_produits_vendus/detail')?>",              
                type:"POST",
                data:
                {
                  key:this.key,
