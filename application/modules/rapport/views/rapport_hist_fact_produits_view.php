      ...
      <div class="card card-block card-stretch card-height">
       <div class="card-header d-flex justify-content-between">
        <div class="header-title">
         <h4 class="card-title">Historique facturations des produits</h4>
       </div>
     </div>
...
Highcharts.chart('container', {
  ...
  title: {
    text: 'Rapport des historique des facturations des produits'
  },
        ...
        point:{
          events: {
           click: function()
           {
                      ...
                      $("#titre").html("Rapport des historique des facturations: "+this.name);
                      ...
                      $("#mytable").DataTable({
                        ...
                        "oreder":[],
                        "ajax":{
                          url:"<?=base_url('rapport/Rapport_hist_fact_produits/detail')?>",
                          type:"POST",
                          data:{
                            key:this.key
                          }
