...
<div class="col-lg-3 col-md-6">
               ...
               <div class="col-lg-6">
                  <div class="card card-block card-stretch card-height">
                     <div class="c-medical-bg" style="background: url(../assets/images/layouts/layout-14/medicine.jpg)center bottom no-repeat;background-size: cover;">
                     ...
                     <div class="card-body recent-appo">                        
                        <div class="media border rounded-normal">
                           <div class="img-icon bg-primary position-relative rounded-small avatar-60">
                              <img src="<?= base_url()?>assets/images/layouts/layout-14/r-1.png"
                        ...
                        <div class="media border rounded-normal spc-20">
                           <div class="img-icon bg-primary position-relative rounded-small avatar-60">
                              <img src="<?= base_url()?>assets/images/layouts/layout-14/r-2.png" class="img-fluid" alt="image">
                           </div>
                           <div class="media-body ml-3">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="card card-block card-stretch card-height">
                     <div class="card-body">                        
                        <div class="media">
                           <img src="<?= base_url()?>assets/images/user/03.jpg" class="avatar-110 rounded" alt="image">
                     ...
                     <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="card-header-toolbar d-flex align-items-center">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right shadow-none" aria-labelledby="dropdownMenuButton7">
                                 <a class="dropdown-item" href="#"><i class="ri-eye-fill mr-2"></i>View</a>
                                 <a class="dropdown-item" href="#"><i class="ri-delete-bin-6-fill mr-2"></i>Delete</a>
                              </div>
                           </div>
                           ...
                           <table class="table table-striped mb-0 table-borderless">
                              ...
                              <tbody>
                                 <tr>
                                    <td>
                                       <div class="media align-items-center">
                                          <img src="<?= base_url()?>assets/images/user/08.jpg" class="img-fluid avatar-35 rounded" alt="image">
                                          <div class="media-body ml-3">
                                    ...
                                    <td>
                                       <img src="<?= base_url()?>assets/images/icon/pdf.png" class="img-fliud" alt="image">
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    <td>
                                       <div class="media align-items-center">
                                          <img src="<?= base_url()?>assets/images/user/03.jpg" class="img-fluid avatar-35 rounded" alt="image">
                                          <div class="media-body ml-3">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="media align-items-center">
                                          <img src="<?= base_url()?>assets/images/user/07.jpg" class="img-fluid avatar-35 rounded" alt="image">
                                          <div class="media-body ml-3">
